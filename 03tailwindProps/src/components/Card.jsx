...
// function Card(props) {  
// function Card({course,array}){ // pura props likhne ki jagah  ha yahi par destructuring bhi kar sakte hai
function Card({course="aryan khanna",array}){ // yaha pe ham default value bhi de sakte h maan lo kisi ne koi value pass ni ki to 
  // console.log(props);
  // props ek object hota hai
  // console.log(props.course,props.array);
